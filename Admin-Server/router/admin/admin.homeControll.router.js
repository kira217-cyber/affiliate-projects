...
// // Game Navigation Routes (Menu, Submenu)
...
// // Game and Provider Routes
// // adminHomeControlRouter.route(
// //   "/submenu-providers",
// //   adminAuthMiddleware,
// //   getSubmenuProviders
// // ); // New route
...
// //   adminAuthMiddleware,
// //   (req, res) => {
// //     console.log("Accessed /submenu-providers route");
// //   }
// // ); // New route

// adminHomeControlRouter.route("/submenu-providers").get(getSubmenuProviders);

// adminHomeControlRouter
//   .route("/game")
//   .get(adminAuthMiddleware, getAllGames)
//   .post(adminAuthMiddleware, createGame);

// adminHomeControlRouter
//   .route("/game/:id")
//   .get(adminAuthMiddleware, getGameById)
//   .put(adminAuthMiddleware, updateGame)
//   .delete(adminAuthMiddleware, deleteGame);
...
} = require("../../controller/admin/adminUserTransaction.controller");
...
adminHomeControlRouter.post("/bannersRegistration", createBannerRegistration); // Create banner
adminHomeControlRouter.get("/bannersRegistration", getBannersRegistration); // Get all banners
adminHomeControlRouter.put(
  "/bannersRegistration/:id",
  updateBannerRegistration
); // Update banner
adminHomeControlRouter.delete(
  "/bannersRegistration/:id",
  deleteBannerRegistration
); // Delete banner
...
adminHomeControlRouter.get(
  "/deposit-search-transaction/search",
  adminAuthMiddleware,
  searchDepositTransactions
);
...
adminHomeControlRouter.get(
  "/withdraw-transaction/:userId",
  adminAuthMiddleware,
  getWithdrawTransactionsByUserId
);

adminHomeControlRouter.get(
  "/withdraw-search-transaction/search",
  adminAuthMiddleware,
  searchWithdrawTransactions
);
